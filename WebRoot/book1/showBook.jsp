		        ...
		        <%
		          ...
		          for(int i=0;i<list.size();i++){
		            ...
		            <tr>
		              ...
		              <td><%=bPo.getPlace()%></td>
		              <td><%=bPo.getPrice()%></td>
		              <td><a href="http://127.0.0.1:8080/pzl/book1/changeBook.jsp?id=<%=bPo.getId()%>">修改</a>
		              <a href="DeleteBookAction?id=<%=bPo.getId()%>" onClick="return confirm('确定删除?');">删除</a>
		                <a href="http://127.0.0.1:8080/pzl/borrowreturn1/borrow.jsp?id=<%=bPo.getId()%>">借书</a>
		                <a href="http://127.0.0.1:8080/pzl/borrowreturn1/return.jsp?id=<%=bPo.getId()%>">还书</a></td>
